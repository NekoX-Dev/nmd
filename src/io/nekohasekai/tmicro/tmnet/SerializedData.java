...
import io.nekohasekai.ktlib.core.LogsKt;
...
public class SerializedData extends AbstractSerializedData {
    ...
    private static final boolean DEBUG = Level.INFO.compareTo(LogsKt.getLOG_LEVEL()) < 0;
    ...
    private void writeInt32(int x, DataOutputStream out) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write int32 error");
                e.printStackTrace();
            }
        }
    }
    ...
    private void writeInt64(long x, DataOutputStream out) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write int64 error");
                e.printStackTrace();
            }
        }
    }
    ...
    public void writeBytes(byte[] b) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write raw error");
                e.printStackTrace();
            }
        }
    }
    ...
    public void writeBytes(byte[] b, int offset, int count) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write bytes error");
                e.printStackTrace();
            }
        }
    }
    ...
    public void writeByte(int i) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write byte error");
                e.printStackTrace();
            }
        }
    }
    ...
    public void writeByteArray(byte[] b) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write byte array error");
                e.printStackTrace();
            }
        }
    }
    ...
    public void writeString(String s) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write string error");
                e.printStackTrace();
            }
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write double error");
                e.printStackTrace();
            }
        }
    }
    ...
    public void writeFloat(float d) {
        try {
            ...
            if (DEBUG) {
                System.err.println("write float error");
                e.printStackTrace();
            }
        }
    }
    ...
    public boolean readBool(boolean exception) {
        ...
        if (exception) {
            ...
            if (DEBUG) {
                System.err.println("Not bool value!");
            }
        }
        return false;
    }
    ...
    public byte readByte(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                if (DEBUG) {
                    System.err.println("read byte error");
                    e.printStackTrace();
                }
            }
        }
    ...
    public void readBytes(byte[] b, boolean exception) {
        try {
            ...
            if (exception) {
                e.printStackTrace();
                throw new RuntimeException("read bytes error");
            } else {
                if (DEBUG) {
                    System.err.println("read bytes error");
                    e.printStackTrace();
                }
            }
        }
    ...
    public String readString(boolean exception) {
        try {
            ...
            if (exception) {
                e.printStackTrace();
                throw new RuntimeException("read string error");
            } else {
                if (DEBUG) {
                    System.err.println("read string error");
                    e.printStackTrace();
                }
            }
        }
    ...
    public byte[] readByteArray(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                if (DEBUG) {
                    System.err.println("read byte array error");
                    e.printStackTrace();
                }
            }
        }
    ...
    public double readDouble(boolean exception) {
        try {
            ...
            if (exception) {
                e.printStackTrace();
                throw new RuntimeException("read double error");
            } else {
                if (DEBUG) {
                    System.err.println("read double error");
                    e.printStackTrace();
                }
            }
        }
    ...
    public float readFloat(boolean exception) {
        try {
            ...
            if (exception) {
                e.printStackTrace();
                throw new RuntimeException("read float error");
            } else {
                if (DEBUG) {
                    System.err.println("read float error");
                    e.printStackTrace();
                }
            }
        }
    ...
    public int readInt32(boolean exception) {
        try {
            ...
            if (exception) {
                e.printStackTrace();
                throw new RuntimeException("read int32 error");
            } else {
                if (DEBUG) {
                    System.err.println("read int32 error");
                    e.printStackTrace();
                }
            }
        }
    ...
    public long readInt64(boolean exception) {
        try {
            ...
            if (exception) {
                e.printStackTrace();
                throw new RuntimeException("read int64 error");
            } else {
                if (DEBUG) {
                    System.err.println("read int64 error");
                    e.printStackTrace();
                }
            }
        }
